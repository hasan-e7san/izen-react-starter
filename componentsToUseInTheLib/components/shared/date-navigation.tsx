    ...
    return (
        <>
            ...
            <div className={cn("grid  z-50", className)}>
                <label className="mb-0 block text-md font-bold">
                    Pick a date
                </label>
                <Popover open={open}>
                    ...
                    <PopoverContent className="w-auto p-0 " align="start" style={{ left: "1rem" }}>
                        <Calendar
                            style={{ left: "1rem" }}
                            mode="range"
                            ...
                            numberOfMonths={3}
                        />
                        <Button onClick={onApplyChanges} className={"m-2"}>Apply</Button>
                    </PopoverContent>
