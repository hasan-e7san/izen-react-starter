...
function cInlineRadioButton({ title, name, items, error, onChange,className, vertical = false, ...res }: CustomRadioButtonProps, ref: React.Ref<HTMLInputElement>) {
...
const InlineRadioButtonSimple = React.forwardRef(cInlineRadioButton);
export default InlineRadioButtonSimple;
