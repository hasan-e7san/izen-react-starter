...
export default function Pagination({ meta, links, url }:{meta:any,links:any,url:string}) {
    return (
        <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                    <p className="text-sm text-gray-700">
                        Showing <span className="font-medium">{(meta.currentPage - 1) * meta.itemsPerPage + 1}</span> to <span className="font-medium">{meta.currentPage * meta.itemsPerPage}</span> of{' '}
